...
from app.services.job_queue import kill_job_process, start_consumer_process, stop_consumer_process
from app.services.job_queue_ws_manager import job_queue_ws_manager
...
async def create_job(job_in: models.Job = Body(...)) -> models.Job:
    """
...
async def update_job(job_id: str, job_in: models.JobUpdate = Body(...)) -> models.Job:
    """
...
async def retry_job(job_id: str) -> dict[str, Any]:
    ...
    job_queue.update_job_status(job_id=job_id, status=models.JobStatus.queued)
