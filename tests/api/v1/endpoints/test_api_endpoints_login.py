...
#     with patch("app.services.notify.send_reset_password_email") as mock_send_email:
#         r = client.post(
...
# async def test_reset_password_for_inactive_user(db_with_user: Session, client: TestClient):
#     """
#     Test that the reset password endpoint returns a 400 if the user is inactive
#     """
#     db_user = await crud.user.update(
